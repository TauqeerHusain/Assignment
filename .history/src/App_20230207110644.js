  ...
  1: [
    {
      ...
      id: 1613468,
      raw: "Goal: Highlight your frontend engineering abilities by creating a small single page app to view tables of events.",
    },
    {
      timestamp: "02/1023/20",
      id: 1613468,
        ...
        <div>
          {selectedEvent &&
            allSingleEventData[selectedEvent.id].map((item, i) => (
              <div key={i} style={{ display: "flex", columnGap: 40 }}>
                <div>
                  <p>timestamp</p>
                  <p>{item.id}</p>
                </div>
